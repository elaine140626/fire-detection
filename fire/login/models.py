...
class User(models.Model):
    ...
    wechat_id = models.CharField(max_length=128, verbose_name="微信openID", default="")
...
class Message(models.Model):
    ...
    serial_number = models.ForeignKey(to='Device', to_field='serial_number', verbose_name='设备号',
